...
class BottomSheetTimeRangePicker : BottomSheetDialogFragment() {
    ...
    private var btnSetTimeRange: Button? = null
    ...
    override fun onCreateView(
        ...
        mView = LayoutInflater.from(context).inflate(R.layout.time_range_picker_layout, container, false)
        startTimePicker = mView?.findViewById(R.id.startTimePicker)
        endTimePicker = mView?.findViewById(R.id.endTimePicker)
        btnSetTimeRange = mView?.findViewById(R.id.btnSetTimeRange)
        tabHost = mView?.findViewById(R.id.tabHost)
        return mView
    }
