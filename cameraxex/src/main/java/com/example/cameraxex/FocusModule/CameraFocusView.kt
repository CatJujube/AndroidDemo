package com.example.cameraxex.FocusModule
...
import com.example.cameraxex.R

/**
 * 对焦动图显示
 */
class CameraFocusView : AppCompatImageView {
    ...
    constructor(context: Context, attrs: AttributeSet?) : super(context, attrs) {
        mAnimation = AnimationUtils.loadAnimation(getContext(), R.anim.focusview_show)
        mHandler = Handler()
        val typedArray = context.obtainStyledAttributes(attrs, R.styleable.CameraFocusView)
        mFocusImg = typedArray.getResourceId(R.styleable.CameraFocusView_focus_focusing_id, NO_ID)
        mFocusSucceedImg =
            typedArray.getResourceId(R.styleable.CameraFocusView_focus_success_id, NO_ID)
        mFocusFailedImg = typedArray.getResourceId(R.styleable.CameraFocusView_focus_fail_id, NO_ID)
        typedArray.recycle()
